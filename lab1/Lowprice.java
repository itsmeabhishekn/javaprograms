...
p3.Data();
p=p3.low(p1, p2);
System.out.println("__Details of First Product__");
p1.display();
System.out.println();
System.out.println("__Details of Second Product__");
p2.display();
System.out.println();
System.out.println("__Details of Third Product__");
p3.display();
System.out.println();
System.out.println("__Product with Lowest Price__");
p.display();
System.out.println();
}
}